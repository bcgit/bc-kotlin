...
var trustCert = certificate {
    serialNumber = BigInteger.valueOf(7906244495041046711)
    issuer = trustName
    notAfter = expDate
    subject = trustName
    ...
    signature {
        Falcon using trustKp.signingKey
    }
}
...
var caCert = certificate {
    ...
    serialNumber = BigInteger.valueOf(7906244495041056711)
...
var eeCert = certificate {
    ...
    serialNumber = BigInteger.valueOf(7906244495042346711)
...
FileWriter("falconpriv.pem").writePEMObject(eeKp.signingKey)

OutputStreamWriter(System.out).writePEMObject(eeCert)
FileWriter("falconeecert.pem").writePEMObject(eeCert)
OutputStreamWriter(System.out).writePEMObject(caCert)
FileWriter("falconcacert.pem").writePEMObject(caCert)
OutputStreamWriter(System.out).writePEMObject(trustCert)
FileWriter("falcontrustcert.pem").writePEMObject(trustCert)
