...
class CompositeGenSpec(val parameterSet: String, override val random: SecureRandom): SignPairGenSpec {
    ...
    companion object: SignGenSpec, VerifyGenSpec {
        override val signType = KeyType.SIGNING.forAlgorithm("COMPOSITE")
        override val verifyType = KeyType.VERIFICATION.forAlgorithm("COMPOSITE")
    }
}